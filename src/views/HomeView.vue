...
<template>
  <v-app>
    ...
    <!-- v-main configurado para ocupar todo el viewport -->
    <v-main class="main-bg d-flex align-center justify-center bg-grey-lighten-4" style="min-height: 100vh;">
